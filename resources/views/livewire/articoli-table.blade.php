                ...
                <table class="table align-middle mb-0 table-hover table-centered">
                    <thead class="">
                        @php
                            ...
                            // Determina categoria attuale e se Ã¨ orologio
                                    ...
                                    <div class="text-center">
                                        @if($articolo->giacenza)
                                            @php
                                                ...
                                                // Se Ã¨ in un prodotto finito, mostra la quantitÃ  originale, altrimenti la residua
                                                ...
                                                <span class="badge rounded-pill bg-{{ $badgeColor }}" 
                                                      ...
                                                      data-bs-content="
                                                        <div class='text-start'>
                                                            <div class='mb-1'><strong>QtÃ  Iniziale:</strong> {{ number_format($articolo->giacenza->quantita, 0, ',', '.') }}</div>
                                                            <div class='mb-1'><strong>QtÃ  Residua:</strong> {{ number_format($articolo->giacenza->quantita_residua, 0, ',', '.') }}</div>
                ...
                <div class="modal-content" wire:keydown.enter.prevent="confermaStampaEtichetta">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">QuantitÃ  da Scaricare</label>
                                <div class="input-group">
                                    <span class="input-group-text">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <br>
                            <strong>QuantitÃ  ripristinabile:</strong> {{ $giacenzaMancante }}
                        </div>
                        <div class="mb-3">
                            <label class="form-label">QuantitÃ  da ripristinare</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Selezione valida per tutte le stampe finchÃ© non la cambi.</small>
                        </div>
