...
^MD30
^PR3
^FO195,8^BQN,2,1^FDLA,{CARICOQR}^FS
^FO245,12^A0N,16,16^FD{CARICO}^FS
^FO245,34^A0N,14,14^FD{PREZZO}^FS
^FO245,52^A0N,12,12^FB140,2,3,L,0^FD{CARATI}^FS
^XZ';
    }
...
^MD30
^CI28
^LH160,8                     ; Taratura Bellagio: ulteriore spostamento a sinistra
^PW552^LL80
